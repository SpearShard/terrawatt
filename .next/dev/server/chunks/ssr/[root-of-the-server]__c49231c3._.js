...
const ProductSection = ({ data, index })=>{
    ...
    const opacityContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTransform"])(scrollYProgress, [
        0.1,
        0.3,
        0.8,
        0.9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                ...
                                children: data.title.split("").map((char, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
-------------------------------------------------- */ function createTexturedCoin(materialsOut, baseColorsOut, baseEmissiveOut) {
    ...
    /* 🔑 FIX: compensate for CylinderGeometry cap UV mirroring */ frontMap.wrapS = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RepeatWrapping"];
    frontMap.repeat.x = -1;
...
function VideoCoin({ progressRef }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])((_, delta)=>{
        ...
        /* ---------- ROTATION ---------- */ if (p > CONFIG.faceCameraStart) {
            g.rotation.y += delta * CONFIG.spinY;
            g.rotation.x += delta * CONFIG.spinX;
        } else {
            const r = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MathUtils"].clamp((CONFIG.faceCameraStart - p) / 0.03, 0, 1);
            g.rotation.x = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MathUtils"].lerp(g.rotation.x, 0, 1 - r);
            g.rotation.y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MathUtils"].lerp(g.rotation.y, 0, 1 - r);
        }
...
function Video() {
    ...
    /* ---------------- VIDEO SETUP (Minimal wake-up — your encoding is perfect now) ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (fgVideoRef.current) {
            setupVideo(fgVideoRef.current, "/iphoneframes/iphonevideo.mp4");
        }
    }, []);
...
//   const [ready, setReady] = useState(false);
//   // useEffect(() => {
//   //   const hasCookie = document.cookie.includes("hasLoadedPulse=true");
//   //   const navSource = sessionStorage.getItem("NAV_SOURCE");
//   //   const action = localStorage.getItem("TW_action");
//   //   if (navSource === "navbar" || action) {
...
//   const hasCookie = document.cookie.includes("hasLoadedPulse=true");
//   const navSource = sessionStorage.getItem("NAV_SOURCE");
//   // ✅ Loader ONLY on first visit or hard reload on Pulse
//   if (!hasCookie && !navSource) {
//     setShowPreloader(true);
//   } else {
//     setShowPreloader(false);
//   }
...
//       <Preloader
//         onDone={() => {
//           document.cookie = "hasLoadedPulse=true; path=/;";
//           setShowPreloader(false);
//           // ✅ Mark Pulse as fully layout-ready
//           requestAnimationFrame(() => {
//             requestAnimationFrame(() => {
...
function Home() {
    ...
    // }, []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const hasSeenPulse = sessionStorage.getItem("HAS_SEEN_PULSE");
        const navSource = sessionStorage.getItem("NAV_SOURCE");
        const navEntry = performance.getEntriesByType("navigation")[0];
        const isReload = navEntry?.type === "reload";
        /**
   * Loader rules (FINAL):
   * - NEVER show if coming from navbar
   * - Show on first visit
   * - Show on hard reload
   */ if (!navSource && (!hasSeenPulse || isReload)) {
            setShowPreloader(true);
        } else {
            setShowPreloader(false);
        }
    ...
    if (showPreloader) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$preloader$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
            onDone: ()=>{
                // ✅ Mark Pulse as seen for this session
                sessionStorage.setItem("HAS_SEEN_PULSE", "true");
                setShowPreloader(false);
                requestAnimationFrame(()=>{
                    requestAnimationFrame(()=>{
                        pulseReadyRef.current = true;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c49231c3._.js.map