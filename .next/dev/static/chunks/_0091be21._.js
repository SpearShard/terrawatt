...
"[project]/components/locomotive.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$locomotive$2d$scroll$2f$dist$2f$locomotive$2d$scroll$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js [app-client] (ecmascript)");
...
function useSmoothScroll() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSmoothScroll.useEffect": ()=>{
            const scroll = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$locomotive$2d$scroll$2f$dist$2f$locomotive$2d$scroll$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]({
            ...
            scroll.on("scroll", {
                "useSmoothScroll.useEffect": (obj)=>{
                    const limit = obj.limit.y;
                    const current = obj.scroll.y;
                    progress.current = Math.min(current / limit, 1);
                }
            }["useSmoothScroll.useEffect"]);
...
_s(useSmoothScroll, "kKKiWznyO2btZR5lAVUMmAjeLL0=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$locomotive$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/locomotive.ts [app-client] (ecmascript)"); // 👈 import the hook
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DashboardAnimation({ dashboardRef }) {
    ...
    const scrollProgress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$locomotive$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(); // 👈 track Locomotive scroll progress
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardAnimation.useEffect": ()=>{
            const dashboardMesh = dashboardRef.current?.[0];
            if (!dashboardMesh) return;
            const video = document.createElement("video");
            video.src = "/dashvid.mp4";
            video.crossOrigin = "anonymous";
            video.muted = true;
            video.loop = true;
            video.playsInline = true;
            ...
            if (planeRef.current) planeRef.current.material = material;
            dashboardMesh.add(uiGroup.current);
            uiGroup.current.position.set(0, 0.7, 0.17);
            uiGroup.current.rotation.set(1.35, 0, 0);
            video.addEventListener("loadedmetadata", {
                "DashboardAnimation.useEffect": ()=>{
                    ...
                    video.play(); // start playback muted for decoding
                }
            }["DashboardAnimation.useEffect"]);
            video.load();
            return ({
    ...
    // Render loop — update video frame smoothly from scroll progress
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
        "DashboardAnimation.useFrame": ()=>{
            ...
            if (!video || !texture || !canvas || !isReadyRef.current) return;
            const ctx = canvas.getContext("2d");
...
_s(DashboardAnimation, "M5d8TKmUg4i6iE9gNEKo4CgogM8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$locomotive$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
...
"[project]/node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* locomotive-scroll v4.1.3 | MIT License | https://github.com/locomotivemtl/locomotive-scroll */ __turbopack_context__.s([
    "Native",
    ()=>Native,
    "Smooth",
    ()=>Smooth,
...
const __TURBOPACK__default__export__ = Smooth;
;
}),
]);

//# sourceMappingURL=_0091be21._.js.map