    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VideoTextureEffect.useEffect": ()=>{
            ...
            setTimeout({
                "VideoTextureEffect.useEffect": ()=>{
                    scene.traverse({
                        "VideoTextureEffect.useEffect": (child)=>{
                            if (child.isMesh) {
                                const mesh = child;
                                ...
                                if (tex) {
                                    ...
                                    mesh.material = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
                                        ...
                                        metalness: 0.1,
                                        roughness: 0.4,
                                        emissive: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]("#000000"),
            ...
            }["VideoTextureEffect.useEffect"], 1500);
        }
    }["VideoTextureEffect.useEffect"], [
        scene
    ]);
...
_s(VideoTextureEffect, "UhCC8wDD2cMyItT8qLKLhYRbhzM=", false, function() {
    return [
...
function Car({ rearLightsRef, dashboardRef, scale = 1.2 }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Car.useEffect": ()=>{
            u(scene, rearLightsRef, dashboardRef);
        }
    }["Car.useEffect"], [
        scene,
        rearLightsRef,
...
//# sourceMappingURL=_105be869._.js.map