...
function DashboardAnimation({ dashboardRef }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardAnimation.useEffect": ()=>{
            ...
            const raf = {
                "DashboardAnimation.useEffect.raf": (time)=>{
                    lenis.raf(time);
                    requestAnimationFrame(raf);
                }
            }["DashboardAnimation.useEffect.raf"];
            requestAnimationFrame(raf);
            lenis.on("scroll", {
                "DashboardAnimation.useEffect": ({ scroll, limit })=>{
                    scrollRef.current = scroll / limit; // normalized 0–1
                }
            }["DashboardAnimation.useEffect"]);
            return ({
                "DashboardAnimation.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardAnimation.useEffect": ()=>{
            ...
            texture.format = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RGBFormat"];
            videoTextureRef.current = texture;
            if (planeRef.current) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
        "DashboardAnimation.useFrame": ()=>{
            ...
            const t = scrollRef.current * duration;
            if (!isNaN(t)) {
                video.currentTime = t;
...
_s(DashboardAnimation, "WNExUJdVsoHCKZuWB9H3FpsY9bc=", false, function() {
    return [
...
//# sourceMappingURL=_533e1ed1._.js.map